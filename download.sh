#set -x
## This code was originally written by Rehabman, was tweaked by me (frenze31) to fit the Envy 4 much better.
...
#For AR9285 wifi
echo "downloading toledaARPT"
echo "https://github.com/toleda/wireless_half-mini/raw/master/Deprecated Files/airport_kext_enabler/toledaARPT.kext.zip"
curl --remote-name --progress-bar --location "https://github.com/toleda/wireless_half-mini/raw/master/Deprecated Files/airport_kext_enabler/toledaARPT.kext.zip"
